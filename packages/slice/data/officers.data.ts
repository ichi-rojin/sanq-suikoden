...
export const OFFICER_SEEDS: OfficerSeed[] = [
  // ===== 官府（済州府・諸県） =====
  {
    ...
    skills: [], startNode: "jizhou", faction: "court", fameOfficial: 70, fameOutlaw: 0, relations: [],
  },
  {
    id: "gao-lian", family: "高", given: "廉", nickname: "神火将", age: 44,
    apt: A(55, 65, 60, 40, 82), val: V(8, 65, 60, 88, 55, 55, 75, 25),
    skills: ["sorcery", "fire"], startNode: "jizhou", faction: "court", fameOfficial: 60, fameOutlaw: 0,
  ...
  },
  {
    ...
    skills: ["charge", "volley"], startNode: "jizhou", faction: "court", fameOfficial: 62, fameOutlaw: 20,
  ...
  },
  {
    ...
    skills: ["volley"], startNode: "yizhou", faction: "court", fameOfficial: 55, fameOutlaw: 25,
  ...
  },
  {
    ...
    skills: ["charge"], startNode: "yizhou", faction: "court", fameOfficial: 58, fameOutlaw: 10,
  ...
  },
  {
    ...
    skills: ["volley"], startNode: "yizhou", faction: "court", fameOfficial: 45, fameOutlaw: 5,
  ...
  },
  {
    ...
    skills: ["charge", "volley"], startNode: "jizhou", faction: "court", fameOfficial: 68, fameOutlaw: 0, relations: [],
  },
  {
    id: "guan-sheng", family: "関", given: "勝", nickname: "大刀", age: 37,
    apt: A(90, 65, 82, 62, 40), val: V(60, 82, 42, 15, 55, 58, 82, 40),
    skills: ["charge"], startNode: "jizhou", faction: "court", fameOfficial: 66, fameOutlaw: 0, relations: [],
  },
  {
    id: "yang-zhi", family: "楊", given: "志", nickname: "青面獣", age: 35,
    apt: A(84, 55, 62, 40, 45), val: V(48, 72, 45, 30, 58, 48, 86, 35),
    skills: ["charge"], startNode: "jizhou", faction: "court", fameOfficial: 40, fameOutlaw: 15, relations: [],
  },
  {
    id: "suo-chao", family: "索", given: "超", nickname: "急先鋒", age: 33,
    apt: A(82, 42, 60, 45, 35), val: V(45, 66, 42, 25, 86, 20, 70, 40),
    skills: ["charge"], startNode: "jizhou", faction: "court", fameOfficial: 48, fameOutlaw: 0, relations: [],
  },
  {
    id: "dong-ping", family: "董", given: "平", nickname: "双槍将", age: 32,
    apt: A(86, 58, 68, 60, 45), val: V(40, 60, 55, 35, 80, 30, 72, 45),
    skills: ["charge"], startNode: "yanggu", faction: "court", fameOfficial: 52, fameOutlaw: 5, relations: [],
  },
  {
    id: "wen-da", family: "聞", given: "達", age: 45,
    apt: A(74, 55, 70, 45, 35), val: V(35, 74, 35, 40, 50, 55, 60, 40),
    skills: [], startNode: "yanggu", faction: "court", fameOfficial: 42, fameOutlaw: 0, relations: [],
  },
  {
    id: "li-cheng", family: "李", given: "成", age: 43,
    apt: A(78, 52, 68, 42, 35), val: V(32, 72, 38, 42, 55, 50, 62, 38),
    skills: ["volley"], startNode: "yizhou", faction: "court", fameOfficial: 44, fameOutlaw: 0, relations: [],
  },
  {
  ...
  },
  {
    ...
    skills: ["ambush"], startNode: "jizhou", faction: "court", fameOfficial: 38, fameOutlaw: 35,
  ...
  // ===== 放浪の豪傑たち =====
  {
    ...
    skills: ["charge"], startNode: "yezhulin", fameOfficial: 10, fameOutlaw: 62,
  ...
  },
  {
    ...
    skills: ["charge", "ambush"], startNode: "yanggu", fameOfficial: 20, fameOutlaw: 68, relations: [],
  },
  {
    id: "li-kui", family: "李", given: "逵", nickname: "黒旋風", age: 31,
    apt: A(88, 20, 42, 40, 30), val: V(58, 45, 20, 15, 98, 4, 55, 88),
    skills: ["charge"], startNode: "jizhou", fameOfficial: 0, fameOutlaw: 48,
  ...
  },
  {
    ...
    skills: ["charge"], startNode: "yezhulin", fameOfficial: 8, fameOutlaw: 40, relations: [],
  },
  {
    id: "shi-qian", family: "時", given: "遷", nickname: "鼓上蚤", age: 32,
    apt: A(40, 60, 35, 40, 86), val: V(45, 42, 25, 60, 40, 55, 30, 50),
    skills: ["ambush"], startNode: "zengtou", fameOfficial: 0, fameOutlaw: 38, relations: [],
  },
  {
    id: "yang-xiong", family: "楊", given: "雄", nickname: "病関索", age: 34,
    apt: A(74, 48, 56, 48, 42), val: V(52, 58, 30, 25, 58, 42, 72, 58),
    skills: ["charge"], startNode: "yizhou", fameOfficial: 25, fameOutlaw: 30,
  ...
  },
  {
    ...
    skills: ["charge", "ambush"], startNode: "yizhou", fameOfficial: 5, fameOutlaw: 42,
  ...
  },
  {
    ...
    skills: ["charge"], startNode: "jizhou", fameOfficial: 50, fameOutlaw: 35,
  ...
  },
  {
    ...
    skills: ["volley", "ambush"], startNode: "jizhou", fameOfficial: 10, fameOutlaw: 45,
